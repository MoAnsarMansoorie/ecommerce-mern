    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium'>
            ...
            <div className='flex items-center gap-5'>
                <img src={assets.search_icon} alt='Search' onClick={() => setShowSearch(true)} className='w-5 cursor-pointer' />
            ...
            <div className={`absolute top-0 bottom-0 right-0 overflow-hidden bg-white transition-all ${visible ? "w-full" : "w-0"} sm:hidden`}>
