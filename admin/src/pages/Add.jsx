...
const Add = ({token}) => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col gap-4 w-full items-start'>
      ...
      <div>
        ...
        <div className='flex gap-4'>
          <label htmlFor='image1'>
            <img className='w-20' src={!image1 ? assets.upload_area : URL.createObjectURL(image1)} alt='Uplaod Image' />
            <input onChange={(e) => setImage1(e.target.files[0])} type="file" id='image1' className="hidden" />
          </label>

          <label htmlFor='image2'>
            <img className='w-20' src={!image2 ? assets.upload_area : URL.createObjectURL(image2)} alt='Uplaod Image' />
            <input onChange={(e) => setImage2(e.target.files[0])} type="file" id='image2' className="hidden" />
          </label>

          <label htmlFor='image3'>
            <img className='w-20' src={!image3 ? assets.upload_area : URL.createObjectURL(image3)} alt='Uplaod Image' />
            <input onChange={(e) => setImage3(e.target.files[0])} type="file" id='image3' className="hidden" />
          </label>

          <label htmlFor='image4'>
            <img className='w-20' src={!image4 ? assets.upload_area : URL.createObjectURL(image4)} alt='Uplaod Image' />
      ...
      <button className='w-28 px-3 py-3 mt-4 bg-black text-white hover:bg-gray-900 rounded-md'>Add</button>
